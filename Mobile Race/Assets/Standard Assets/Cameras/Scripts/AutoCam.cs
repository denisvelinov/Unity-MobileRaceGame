...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float m_TargetHeightOffset;
        //[SerializeField] private float m_TargetDepttOffset;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, new Vector3(m_Target.position.x, m_Target.position.y + m_TargetHeightOffset, m_Target.position.z), deltaTime * m_MoveSpeed);
            //transform.position = Vector3.Lerp(new Vector3(transform.position.x, transform.position.y + m_TargetHeightOffset, transform.position.z + m_TargetDepttOffset), m_Target.position, deltaTime * m_MoveSpeed);
